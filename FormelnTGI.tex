...
$\mathbf{U_a(t) = k_1 + k_2 \cdot e^{-\frac{t-t_0}{\tau}}}$\\
...
Reale Diode sperrt: $\Rightarrow I_D(raus) = -I_S$\\
...
MS-FF: $c_M=0,c_S=1 \Rightarrow$ +Flake
...
-ZF- und Atab. hat Binärkod. der Zustandskodierung(K), Eingang(E), Zustände(Q), \\FF-E(J,K) $|$, Folgezustände(Q+), Ausgänge(A \textbf{Gegenwart}), \\ Folgekodierung(k+)\\
\end{minipage}
~~~~~~~
\begin{minipage}{0.33\textwidth}
